...
public class NomeEventoTest {
	...
	public void nomeDoEventoMaiorQue150Caracteres() {
		Assert.assertEquals(true, this.validador.nomeEventoMaiorIgual150Caracteres(caracteres(151)));
	}

	@Test
	public void nomeDoEventoMenorQue150Caracteres() {
		Assert.assertEquals(false, this.validador.nomeEventoMaiorIgual150Caracteres(caracteres(50)));
	}

	@Test
	public void nomeDoEventoIgual150Caracteres() {
		Assert.assertEquals(false, this.validador.nomeEventoMaiorIgual150Caracteres(caracteres(150)));
	}
}
